    ...
    <div>
            ...
            <div class="container-fluid">
                ...
                <Row :gutter="16">
                    ...
                    <Col :xs="24" :sm="24" :md="12" :lg="18">
                        ...
                        <Row v-show="initMealPackages" :gutter="16">
                            <div class="flex-box" v-if="mealpackages.length">
                                <Col
                                    v-for="(mealpackage, i) in mealpackages"
                                    :key="i"
                                    :xs="24"
                                    :sm="24"
                                    :md="12"
                                ...
                                >
                                    <div class>
                                        <div class="clash-card barbarian">
                                            ...
                                            ></div>
                                            <div
                                                class="clash-card__level clash-card__level--barbarian"
                                            >
                                                {{ mealpackage.title }}
                                            </div>
                                            <div
                                                class="clash-card__unit-name"
                                            ></div>
                                            <div
                                                v-html="mealpackage.recipe"
                                                class="clash-card__unit-description"
                                            ></div>
                        ...
                        <Row v-show="filteredPackages" :gutter="16">
                            <div class="flex-box" v-if="filteredData.length">
                                <Col
                                    v-for="(mealpackage, i) in filteredData"
                                    :key="i"
                                    :xs="24"
                                    :sm="24"
                                    :md="12"
        ...
        >
            ...
            <div slot="footer">
                ...
                <Button
                    ...
                    :disabled="isAdding"
                    :loading="isAdding"
                    >{{ isAdding ? "Adding..." : "Add Package" }}</Button
                >
            </div>
        </Modal>
        ...
        >
            ...
            <Row>
                <Col span="24">
                    <vue-editor
                        v-model="editPackageData.recipe"
                        :editorToolbar="customToolbar"
                    ></vue-editor>
                </Col>
            </Row>
            ...
            <Row :gutter="16">
                <Col span="12">
                    ...
                    <Select
                        filterable
                        placeholder="Select Meal Plan"
                        v-model="editPackageData.mealplan_id"
                    >
                        <Option
                            v-for="(m, i) in mealplans"
                            :value="m.id"
            ...
            <div
                ...
                v-if="editPackageData.featuredImage"
            >
            ...
            <div slot="footer">
                <Button type="error" @click="editPackageModal = false"
                    >Close</Button
                >
                <Button
                    type="primary"
                    ...
                    :disabled="isEditing"
                    :loading="isEditing"
                    >{{ isEditing ? "Editing..." : "Edit Package" }}</Button
                >
            </div>
        </Modal>
    ...
    methods: {
        ...
        async deleteImage(isAdd = true) {
            ...
            if (!isAdd) {
                ...
                const countImage = await this.callApi(
                    "post",
                    "app/count_images",
                    {
                        imageName: image
        ...
        async getNewPackages() {
            const res = await this.callApi("get", "app/get_packages");
            this.mealpackages = res.data;
        },
        async filterPackages() {
            if (this.filterData.mealplan_id == null)
                return this.error("Meal Plan required is required");
            if (this.filterData.mealplanduration_id == null)
                return this.error("Meal Duration required is required");
            this.initMealPackages = false;
            const res = await this.callApi(
                "post",
                "app/filter_packages",
                this.filterData
            ...
            this.filteredPackages = true;
        },
        showAllPackages() {
            this.filteredPackages = false;
            this.initMealPackages = true;
